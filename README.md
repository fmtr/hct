...
```be
tasmota.urlfetch('https://raw.githubusercontent.com/fmtr/hct/v0.0.5/hct.be','/hct.be')
```

Alternatively, manually download [hct.be](https://raw.githubusercontent.com/fmtr/hct/v0.0.5/hct.be) and upload it onto
your device.
